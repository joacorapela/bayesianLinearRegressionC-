...
public class BatchRegressionObsAndPosteriorsVis : IObserver<BatchRegressionObsAndPosterior>
{
    ...
    {
        Console.WriteLine("BatchRegressionObsAndPosteriorsVis::OnNext called");
